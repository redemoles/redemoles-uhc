...
execute if score #{bingo_namespace}_enabled {configuration_objective} matches 1 run function #bhc:line_{line}/column_{column} with storage {bingo_namespace} {line}_{column}
