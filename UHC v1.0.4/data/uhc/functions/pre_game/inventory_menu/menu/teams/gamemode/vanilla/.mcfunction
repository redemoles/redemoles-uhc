...
#> uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/
#
...
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/01 with storage uhc:team

scoreboard players set #team uhc.id.teams 2
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/02 with storage uhc:team

scoreboard players set #team uhc.id.teams 3
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/03 with storage uhc:team

scoreboard players set #team uhc.id.teams 4
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/04 with storage uhc:team

scoreboard players set #team uhc.id.teams 5
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/05 with storage uhc:team

scoreboard players set #team uhc.id.teams 6
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/06 with storage uhc:team

scoreboard players set #team uhc.id.teams 7
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/07 with storage uhc:team

scoreboard players set #team uhc.id.teams 8
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/08 with storage uhc:team

scoreboard players set #team uhc.id.teams 9
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/09 with storage uhc:team

scoreboard players set #team uhc.id.teams 10
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/10 with storage uhc:team

scoreboard players set #team uhc.id.teams 11
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/11 with storage uhc:team

scoreboard players set #team uhc.id.teams 12
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/teams/12 with storage uhc:team

function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/spec/
function uhc:pre_game/inventory_menu/menu/teams/gamemode/vanilla/spec/players with storage uhc:team
