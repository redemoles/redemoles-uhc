...
#> uhc:pre_game/inventory_menu/menu/teams/join/09
#
...
tag @s add Joueur
team join 09 @s
execute if score #vanilla uhc.gamemode matches 1 run tellraw @s [{"text":"Tu viens de rejoindre l'","color":"aqua","bold":false},{"text":"Équipe Rouge c.","color":"red","bold":false}]
