...
#> uhc:pre_game/inventory_menu/menu/teams/join/16
#
...
tag @s add Joueur
team join 16 @s
execute if score #vanilla uhc.gamemode matches 1 run tellraw @s [{"text":"Tu viens de rejoindre l'","color":"aqua","bold":false},{"text":"Équipe Noire","color":"black","bold":false}]
