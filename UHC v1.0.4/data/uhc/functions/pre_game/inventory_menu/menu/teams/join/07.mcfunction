...
#> uhc:pre_game/inventory_menu/menu/teams/join/07
#
...
tag @s add Joueur
team join 07 @s
execute if score #vanilla uhc.gamemode matches 1 run tellraw @s [{"text":"Tu viens de rejoindre l'","color":"aqua","bold":false},{"text":"Équipe Jaune","color":"yellow","bold":false}]
