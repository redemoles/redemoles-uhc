...
#> uhc:pre_game/inventory_menu/menu/teams/join/13
#
...
tag @s add Joueur
team join 13 @s
execute if score #vanilla uhc.gamemode matches 1 run tellraw @s [{"text":"Tu viens de rejoindre l'","color":"aqua","bold":false},{"text":"Équipe Blanche","color":"white","bold":false}]
