...
execute as @s[tag=Host] if score #teams uhc.host.menu matches 1 run function uhc:pre_game/inventory_menu/menu/teams/gamemode/bhc_beta/
execute as @s[tag=!Host] run function uhc:pre_game/inventory_menu/menu/teams/gamemode/bhc_beta/
