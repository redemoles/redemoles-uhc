...
item replace entity @s inventory.1 with minecraft:red_concrete{display:{Name:'{"text":"1000/-1000","color":"#3FFFFF","italic":false}'}}
item replace entity @s inventory.2 with minecraft:red_concrete{display:{Name:'{"text":"2000/-2000","color":"#3FFFFF","italic":false}'}}
