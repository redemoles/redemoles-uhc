...
#> uhc:pre_game/command_host/menu/gamemode/bhc/
#
...
execute if score #bhc bhc.scenario matches 0 run item replace entity @s inventory.1 with minecraft:sea_lantern{display:{Name:'{"text":"BHC Beta","color":"#5F5FAF","italic":false}'}}
execute if score #bhc bhc.scenario matches 1 run item replace entity @s inventory.2 with minecraft:sea_lantern{display:{Name:'{"text":"BHC I","color":"#5F5FFF","italic":false}'}}
execute if score #bhc bhc.scenario matches 2 run item replace entity @s inventory.3 with minecraft:sea_lantern{display:{Name:'{"text":"BHC II","color":"#5FAFFF","italic":false}'}}
execute if score #bhc bhc.scenario matches 3 run item replace entity @s inventory.4 with minecraft:sea_lantern{display:{Name:'{"text":"BHC III","color":"#5FFFFF","italic":false}'}}
execute if score #bhc bhc.scenario matches 4 run item replace entity @s inventory.5 with minecraft:sea_lantern{display:{Name:'{"text":"BHC IV","color":"#5FAF5F","italic":false}'}}
execute if score #bhc bhc.scenario matches 5 run item replace entity @s inventory.6 with minecraft:sea_lantern{display:{Name:'{"text":"BHC V","color":"#5FFF5F","italic":false}'}}
execute if score #bhc bhc.scenario matches 6 run item replace entity @s inventory.7 with minecraft:sea_lantern{display:{Name:'{"text":"BHC VI","color":"#FFFF5F","italic":false}'}}
execute if score #bhc bhc.scenario matches 7 run item replace entity @s inventory.10 with minecraft:sea_lantern{display:{Name:'{"text":"BHC VII","color":"#FFAF5F","italic":false}'}}
execute if score #bhc bhc.scenario matches 8 run item replace entity @s inventory.11 with minecraft:sea_lantern{display:{Name:'{"text":"BHC VIII","color":"#FF5F5F","italic":false}'}}
