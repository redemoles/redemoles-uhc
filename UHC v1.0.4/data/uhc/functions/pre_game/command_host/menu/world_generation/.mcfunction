...
#> uhc:pre_game/command_host/menu/world_generation/
#
...
execute unless score @s[tag=!host.world_generation.4000] pregen.world matches 4 run item replace entity @s inventory.2 with minecraft:red_concrete{display:{Name:'{"text":"2000/-2000","color":"#3FFFFF","italic":false}'}}
