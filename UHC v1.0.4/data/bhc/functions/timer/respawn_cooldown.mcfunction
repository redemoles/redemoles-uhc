...
#execute if score @s uhc.timer.respawn matches 31 run title @s subtitle [{"text":"Respawn","color":"#BF7FFF","bold":true},{"text":"","color":"#FFE73F","bold":false}]
...
#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 2 if score #vie2 BHC.timer matches 1.. run title @s subtitle [{"text":"❤❤❤","color":"#3FFFFF", "bold":false}]
...
#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 2 if score #vie2 BHC.timer matches 1.. run title @s subtitle [{"text":"❤❤","color":"#FFE73F", "bold":false}, {"text":"❤","color":"#3F3F3F", "bold":false}]

#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 1 if score #vie2 BHC.timer matches 1.. run title @s subtitle [{"text":"❤❤","color":"#FFE73F", "bold":false}, {"text":"❤","color":"#3F3F3F", "bold":false}]
...
#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 1 if score #vie2 BHC.timer matches 1.. run title @s subtitle [{"text":"❤","color":"#E73F3F", "bold":false}, {"text":"❤❤","color":"#3F3F3F", "bold":false}]

#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 1 if score #vie2 BHC.timer matches ..0 run title @s subtitle [{"text":"❤❤","color":"#FFE73F", "bold":false}]
...
#execute if score @s uhc.timer.respawn matches 31 if score @s uhc.players.lives matches 1 if score #vie2 BHC.timer matches ..0 run title @s subtitle [{"text":"❤","color":"#E73F3F", "bold":false}, {"text":"❤","color":"#3F3F3F", "bold":false}]
