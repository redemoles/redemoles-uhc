...
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunck_pregen pregen.world matches 2000..2999 run function wp:region/2000x2000
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunck_pregen pregen.world matches 4000..4999 run function wp:region/4000x4000
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunck_pregen pregen.world matches 5000..5999 run function wp:region/nether
