...
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunk_pregen pregen.world matches 2000..2999 run function pregen:region/2000x2000
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunk_pregen pregen.world matches 4000..5999 run function pregen:region/4000x4000
execute if score #tick_pregen pregen.world matches 20 run execute if score #chunk_pregen pregen.world matches 6000..6999 run function pregen:region/nether
