...
tellraw @a[scores={uhc.players.lang=1}] [{"text":"[","color":"#DFC300","bold":true},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#2FAFBF"},{"text":"]","color":"#DFC300"},{"text":" La partie vient de démarrer !\n","color":"#FFE73F","bold":true}]
tellraw @a[scores={uhc.players.lang=2}] [{"text":"[","color":"#DFC300","bold":true},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#2FAFBF"},{"text":"]","color":"#DFC300"},{"text":" Game starting now!\n","color":"#FFE73F","bold":true}]
