...
## Messages
$execute if score #first_time aic.data.score matches 1 run tellraw @a[scores={uhc.players.lang=061801}] [{"text":""},{"selector":"@s","bold":true},{"text":" vient de terminer la collection : ","color":"#FFE73F"},{"text":"$(collection_name)","color":"#3FE7FF"}]
$execute if score #first_time aic.data.score matches 1 run tellraw @a[scores={uhc.players.lang=051407}] [{"text":""},{"selector":"@s","bold":true},{"text":" just completed the collection: ","color":"#FFE73F"},{"text":"$(collection_name)","color":"#3FE7FF"}]
