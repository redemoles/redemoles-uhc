...
execute if entity @s[scores={lobby.tc.red_concrete_powder_placed=1}] run scoreboard players add #team_01 lobby.tc.player.score 1
...
execute if entity @s[scores={lobby.tc.red_concrete_powder_placed=1}] as @a unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run title @s title [{"text":"+1","color":"red"}]
...
execute if entity @s[scores={lobby.tc.red_concrete_powder_placed=1}] run playsound minecraft:block.note_block.bell master @s ~ ~ ~ 0.5 1 0.5

execute if entity @s[scores={lobby.tc.blue_concrete_powder_placed=1}] run scoreboard players add #team_02 lobby.tc.player.score 1
...
execute if entity @s[scores={lobby.tc.blue_concrete_powder_placed=1}] as @a unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run title @s title [{"text":"+1","color":"blue"}]
...
execute if entity @s[scores={lobby.tc.blue_concrete_powder_placed=1}] run playsound minecraft:block.note_block.bell master @s ~ ~ ~ 0.5 1 0.5
