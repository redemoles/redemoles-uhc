...
execute if entity @s[tag=mgs.tc.team.01] as @a[tag=mgs.tc.team.01,scores={uhc.players.lang=1}] run title @s subtitle [{"text":"L'équipe adverse reçoit surbrillance pendant 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.01] as @a[tag=mgs.tc.team.02,scores={uhc.players.lang=1}] run title @s subtitle [{"text":"Ton équipe reçoit surbrillance pendant 40s","color":"#FF3F3F"}]

execute if entity @s[tag=mgs.tc.team.02] as @a[tag=mgs.tc.team.02,scores={uhc.players.lang=1}] run title @s subtitle [{"text":"L'équipe adverse reçoit surbrillance pendant 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.02] as @a[tag=mgs.tc.team.01,scores={uhc.players.lang=1}] run title @s subtitle [{"text":"Ton équipe reçoit surbrillance pendant 40s","color":"#FF3F3F"}]
