...
execute if score #team_01 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 1..3 as @a[tag=mgs.tc.player,tag=mgs.tc.team.02] run function lobby:mini_games/tc/mini_games/memory_build/record/taiga/time
execute if score #team_02 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 1..3 as @a[tag=mgs.tc.player,tag=mgs.tc.team.01] run function lobby:mini_games/tc/mini_games/memory_build/record/taiga/time
execute if score #team_01 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 4..6 as @a[tag=mgs.tc.player,tag=mgs.tc.team.02] run function lobby:mini_games/tc/mini_games/memory_build/record/jungle/time
execute if score #team_02 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 4..6 as @a[tag=mgs.tc.player,tag=mgs.tc.team.01] run function lobby:mini_games/tc/mini_games/memory_build/record/jungle/time
execute if score #team_01 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 7..9 as @a[tag=mgs.tc.player,tag=mgs.tc.team.02] run function lobby:mini_games/tc/mini_games/memory_build/record/cherry/time
execute if score #team_02 lobby.tc.player.score matches 1 if score #random_memory_build_pick lobby.tc.data matches 7..9 as @a[tag=mgs.tc.player,tag=mgs.tc.team.01] run function lobby:mini_games/tc/mini_games/memory_build/record/cherry/time
