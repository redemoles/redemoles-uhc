...
execute if score #random_parkour_pick lobby.tc.data matches 3 run place template lobby:mini_games/tc/parkour/piston_slime_01
execute if score #random_parkour_pick lobby.tc.data matches 4 run place template lobby:mini_games/tc/parkour/chains
