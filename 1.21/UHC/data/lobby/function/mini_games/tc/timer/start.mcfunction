...
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run title @s times 0s 2s 0.5s
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run tag @s remove mgs.tc.spec
# Effets
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run function lobby:mini_games/tc/timer/start_effects
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run effect give @s minecraft:blindness infinite 0 true
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run effect give @s minecraft:invisibility infinite 0 true
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run effect give @s minecraft:slowness infinite 9 true
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] run attribute @s minecraft:jump_strength base set 0.0
...
execute if score #timer_start_tick lobby.tc.data matches 121 run scoreboard players set #team_01 lobby.tc.player.score 0
execute if score #timer_start_tick lobby.tc.data matches 121 run scoreboard players set #team_02 lobby.tc.player.score 0

# Inventaire
execute if score #timer_start_tick lobby.tc.data matches 120 run scoreboard players set @a[tag=mgs.tc.player] lobby.tc.inventory 1
execute if score #timer_start_tick lobby.tc.data matches 120 run clear @a[tag=mgs.tc.player]
execute if score #timer_start_tick lobby.tc.data matches 120 run advancement grant @a[tag=mgs.tc.player] only uhc:inventory_menu
...
execute if score #timer_start_tick lobby.tc.data matches 121 as @a[tag=mgs.tc.player] unless score @s lobby.tc.player.score matches 1.. run scoreboard players set @s lobby.tc.player.score 0
execute if score #timer_start_tick lobby.tc.data matches 121 run scoreboard objectives setdisplay sidebar lobby.tc.player.score
