...
execute unless score #timer_start_tick lobby.tc.data matches 1.. as @e[type=marker,predicate=lobby:id_mini_games,tag=lobby.tc.puzzle] run function lobby:mini_games/tc/timer/map_pick
