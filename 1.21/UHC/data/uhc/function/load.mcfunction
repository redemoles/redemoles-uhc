...
tellraw @a[tag=uhc.host] [{"text":"\n[","color":"#6F6F6F"},{"text":"UHC 25s22b","color":"#FFE73F"},{"text":" - "},{"text":"pour ","color":"#E7E7E7"},{"text":"MC 1.21.5","color":"#3FE7FF"},{"text":" - "},{"text":"par ","color":"#E7E7E7"},{"text":"Redemoles","color":"#CF3FFF"},{"text":"]"}]
