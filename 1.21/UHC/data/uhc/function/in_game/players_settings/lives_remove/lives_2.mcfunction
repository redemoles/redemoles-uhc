...
## Message
# FRA
execute unless score #bhc uhc.gamemode matches 1 if score #live_2 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=1}] [{"text":"Tu as subit une réduction de vie forcée. Voilà 2 pommes d'or pour compenser.","color":"#FFE73F","bold":false}]
execute if score #bhc uhc.gamemode matches 1 if score #live_2 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=1}] [{"text":"Bravo, tu as tenu jusqu'à la réduction de vie forcée !","color":"#FFEF7F","bold":false},{"text":"\nTu obtiens 2 pommes d'or, et ton équipe reçoit ","color":"#FFE73F","bold":false},{"text":"10","color":"#00DFDF","bold":true},{"text":" points de ","color":"#7FFFFF","bold":false},{"text":"Survie","color":"#3FFFF","bold":true},{"text":".","color":"#7FFFFF","bold":false}]

# ENG
execute unless score #bhc uhc.gamemode matches 1 if score #live_2 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=2}] [{"text":"You've suffered a forced life reduction. Here are 2 golden apples to compensate.","color":"#FFE73F","bold":false}]
execute if score #bhc uhc.gamemode matches 1 if score #live_2 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=2}] [{"text":"Congratulations, you've survived to the point of forced life reduction!","color":"#FFEF7F","bold":false},{"text":"\nYou get 2 golden apples, and your team receives ","color":"#FFE73F","bold":false},{"text":"10","color":"#00DFDF","bold":true},{"text":" ","bold":false},{"text":"Survival","color":"#3FFFF","bold":true},{"text":" points.","color":"#7FFFFF","bold":false}]
