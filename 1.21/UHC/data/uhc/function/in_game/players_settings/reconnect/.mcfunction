...
execute if score #minutes uhc.data.temp matches 0.. if score #ironman uhc.data.setup matches 1.. run tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Ironman ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" Pour voir les joueurs dans la liste :","color":"#FFFFFF","bold":false},{"text":"\n/trigger ironman.list","color":"#FFE73F","bold":false}]
execute if score #minutes uhc.data.temp matches 0.. if score #ironman uhc.data.setup matches 1.. run tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Ironman ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" To see the players list :","color":"#FFFFFF","bold":false},{"text":"\n/trigger ironman.list","color":"#FFE73F","bold":false}]

# Message trigger Best PvE
execute if score #minutes uhc.data.temp matches 0.. if score #best_pve uhc.scenario matches 1 run tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Best PvE ","color":"#E73F3F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" Pour voir les joueurs dans la liste :","color":"#FFFFFF","bold":false},{"text":"\n/trigger best_pve.list","color":"#FFE73F","bold":false}]
execute if score #minutes uhc.data.temp matches 0.. if score #best_pve uhc.scenario matches 1 run tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Best PvE ","color":"#E73F3F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" To see the players list :","color":"#FFFFFF","bold":false},{"text":"\n/trigger best_pve.list","color":"#FFE73F","bold":false}]
