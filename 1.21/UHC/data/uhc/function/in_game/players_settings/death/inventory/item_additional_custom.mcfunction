...
#> uhc:in_game/players_settings/death/inventory/item_additional_custom
#
...
execute if data storage uhc:temp Item_additional[0] run function uhc:in_game/players_settings/death/inventory/item_additional_custom
