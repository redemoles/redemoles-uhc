...
execute if score @s uhc.players.lives matches 1.. if score #Minutes uhc.data.display matches ..59 if score @s uhc.meetup.activate matches 2 run function uhc:in_game/tp/spawn_end
