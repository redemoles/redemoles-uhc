...
execute if score #pvp uhc.data.temp matches 0 run scoreboard players set #no_pvp_safety uhc.data.temp 0
...
execute if score #aic uhc.gamemode matches 3 in uhc:lobby run function aic:timer/minute
