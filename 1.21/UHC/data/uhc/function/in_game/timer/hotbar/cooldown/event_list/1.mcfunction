...
#> uhc:in_game/timer/hotbar/cooldown/min_1/1
#
# @within			uhc:in_game/timer/hotbar/cooldown/min_1/
#
#
...
execute if score #shrink_1 uhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"de la ","color":"#FFFFFF"}, {"text":"réduction","color":"#FF3F3F"}]
execute if score #shrink_1 uhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"of the ","color":"#FFFFFF"}, {"text":"shrinkage","color":"#FF3F3F"}]
