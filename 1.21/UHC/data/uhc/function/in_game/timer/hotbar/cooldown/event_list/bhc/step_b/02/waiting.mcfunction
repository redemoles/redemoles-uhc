...
#> uhc:in_game/timer/hotbar/cooldown/event_list/bhc/step_b/02/waiting
#
...
execute if score #stepb_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"l'","color":"#FFFFFF"}, {"text":"Ère Viking","color":"#CF6F3F"}]
execute if score #stepb_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"the ","color":"#FFFFFF"}, {"text":"Viking Era","color":"#CF6F3F"}]
...
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"fin de l'","color":"#FFFFFF"}, {"text":"Ère Viking","color":"#CF6F3F"}]
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"end of the ","color":"#FFFFFF"}, {"text":"Viking Era","color":"#CF6F3F"}]
