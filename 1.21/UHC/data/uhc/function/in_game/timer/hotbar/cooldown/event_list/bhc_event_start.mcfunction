...
execute if score #stepa_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"Start of ","color":"#FFFFFF"}, {"text":"Classic Bingo","color":"#9F3FFF"}]
...
execute if score #stepa_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"End of ","color":"#FFFFFF"}, {"text":"Classic Bingo","color":"#9F3FFF"}]
