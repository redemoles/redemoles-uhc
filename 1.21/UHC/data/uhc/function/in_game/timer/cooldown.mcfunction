...
$execute if score #shrink_1 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=1}] [{"text":"\nRéduction activée !","color":"#FF3F3F","bold":true},{"text":"\nFin de la réduction dans ","color":"#FFFFFF","bold":false},{"text":"$(border_length) minutes","color":"#FF3F3F","bold":false},{"text":" en ","color":"#FFFFFF","bold":false},{"text":"$(border_size)","color":"#FF3F3F","bold":false},{"text":"/","color":"#FFFFFF","bold":false},{"text":"-","color":"#FF3F3F","bold":false},{"text":"$(border_size)","color":"#FF3F3F","bold":false}]
...
$execute if score #shrink_1 uhc.data.setup matches 0 run tellraw @a[scores={uhc.players.lang=2}] [{"text":"\nShrink enabled!","color":"#FF3F3F","bold":true},{"text":"\nThe shrink will end in ","color":"#FFFFFF","bold":false},{"text":"$(border_length) minutes","color":"#FF3F3F","bold":false},{"text":" at ","color":"#FFFFFF","bold":false},{"text":"$(border_size)","color":"#FF3F3F","bold":false},{"text":"/","color":"#FFFFFF","bold":false},{"text":"-","color":"#FF3F3F","bold":false},{"text":"$(border_size)","color":"#FF3F3F","bold":false}]
