...
# Red Arrows
execute if score #red_arrows uhc.scenario matches 1 unless dimension minecraft:the_nether positioned over motion_blocking_no_leaves run function uhc:in_game/scenarios/red_arrows/
