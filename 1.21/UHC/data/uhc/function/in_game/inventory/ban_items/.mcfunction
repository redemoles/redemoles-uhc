...
execute if score #tick_start uhc.data.temp matches 0.. run tag @s add uhc.inventory_changed
...
# Compensation Items
execute if data entity @s[tag=uhc.inventory_changed] Inventory[{id:"minecraft:enchanted_golden_apple"}] unless data entity @s[tag=uhc.inventory_changed] Inventory[{id:"minecraft:totem_of_undying"}] run function uhc:in_game/inventory/ban_items/compensation
execute if data entity @s[tag=uhc.inventory_changed] Inventory[{id:"minecraft:totem_of_undying"}] run function uhc:in_game/inventory/ban_items/compensation
