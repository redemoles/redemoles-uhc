...
execute if score #bhc uhc.gamemode matches 1 if score #end uhc.game.end matches 1 as @n[type=marker,tag=UHC,distance=0..,predicate=uhc:id_team_alive] run function bhc:scores_calculator/endgame/detect
...
# Msg FRA
execute if score #fte uhc.gamemode matches 1 run tellraw @a[scores={uhc.players.lang=061801}] [{"text":"La partie est terminée !\nLa victoire est attribué à ","color":"#FFFFFF"},{"selector":"@a[predicate=uhc:id_team_alive]","bold":true,"color":"#FF3F3F"},{"text":" !\n","color":"#FFFFFF"}]
execute if score #vanilla uhc.gamemode matches 1 run tellraw @a[scores={uhc.players.lang=061801}] [{"text":"La partie est terminée !\nLa victoire est attribué à ","color":"#3FE7FF"},{"selector":"@a[predicate=uhc:id_team_alive]","bold":true,"color":"#2FAFBF"},{"text":" !\n","color":"#3FE7FF"}]

# Msg ENG
execute if score #fte uhc.gamemode matches 1 run tellraw @a[scores={uhc.players.lang=051407}] [{"text":"The game is over!\nThe victory is attributed to ","color":"#FFFFFF"},{"selector":"@a[predicate=uhc:id_team_alive]","bold":true,"color":"#FF3F3F"},{"text":" !\n","color":"#FFFFFF"}]
execute if score #vanilla uhc.gamemode matches 1 run tellraw @a[scores={uhc.players.lang=051407}] [{"text":"The game is over!\nThe victory is attributed to ","color":"#3FE7FF"},{"selector":"@a[predicate=uhc:id_team_alive]","bold":true,"color":"#2FAFBF"},{"text":" !\n","color":"#3FE7FF"}]
