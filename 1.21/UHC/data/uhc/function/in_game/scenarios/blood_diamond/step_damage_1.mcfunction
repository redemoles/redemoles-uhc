...
$tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Blood Diamond ($(mined)/∞) ","color":"#FF3F3F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" -$(damage) PV, +1 diamant (100%)","color":"#FF3F3F","bold":false}]

$tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Blood Diamond ($(mined)/∞) ","color":"#FF3F3F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" -$(damage) HP, +1 diamond (100%)","color":"#FF3F3F","bold":false}]
