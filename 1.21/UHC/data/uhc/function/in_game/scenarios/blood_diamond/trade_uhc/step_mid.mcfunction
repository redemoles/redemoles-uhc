...
$execute if score #random uhc.scenario.blood_diamond.temp matches 51..75 run tellraw @s[scores={uhc.players.lang=1}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) >","color":"#FFE73F","bold":true},{"text":" +1 émeraude (25%)","color":"#3FE7FF","bold":false}]
$execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @s[scores={uhc.players.lang=1}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) >","color":"#FFE73F","bold":true},{"text":" +1 émeraude pour ","color":"#FF3F3F","bold":false},{"selector":"@p[tag=uhc.blood_diamond.receive]","bold":false},{"text":" (25%)","color":"#FF3F3F","bold":false}]
...
$execute if score #random uhc.scenario.blood_diamond.temp matches 51..75 run tellraw @s[scores={uhc.players.lang=2}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) >","color":"#FFE73F","bold":true},{"text":" +1 emerald (25%)","color":"#3FE7FF","bold":false}]
$execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @s[scores={uhc.players.lang=2}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) >","color":"#FFE73F","bold":true},{"text":" +1 emerald for ","color":"#FF3F3F","bold":false},{"selector":"@p[tag=uhc.blood_diamond.receive]","bold":false},{"text":" (25%)","color":"#FF3F3F","bold":false}]
