...
give @s emerald
$tellraw @s[scores={uhc.players.lang=1}] [{"text":"Blood Diamond ($(mined)/8) >","color":"#3FE7FF","bold":true},{"text":" +1 émeraude (100%)","color":"#3FE7FF","bold":false}]
$tellraw @s[scores={uhc.players.lang=2}] [{"text":"Blood Diamond ($(mined)/8) >","color":"#3FE7FF","bold":true},{"text":" +1 emerald (100%)","color":"#3FE7FF","bold":false}]
