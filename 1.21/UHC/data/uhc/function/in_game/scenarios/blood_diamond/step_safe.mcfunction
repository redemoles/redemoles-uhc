...
$tellraw @s[scores={uhc.players.lang=1}] [{"text":"Blood Diamond ($(mined)/$(end_tier_1)) >","color":"#3FE7FF","bold":true},{"text":" +1 diamant (100%)","color":"#3FE7FF","bold":false}]
$tellraw @s[scores={uhc.players.lang=2}] [{"text":"Blood Diamond ($(mined)/$(end_tier_1)) >","color":"#3FE7FF","bold":true},{"text":" +1 diamond (100%)","color":"#3FE7FF","bold":false}]
