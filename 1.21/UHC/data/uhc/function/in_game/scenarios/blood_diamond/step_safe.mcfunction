...
$tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Blood Diamond ($(mined)/$(end_tier_1)) ","color":"#3FE7FF","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamant (100%)","color":"#3FE7FF","bold":false}]
$tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Blood Diamond ($(mined)/$(end_tier_1)) ","color":"#3FE7FF","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamond (100%)","color":"#3FE7FF","bold":false}]
