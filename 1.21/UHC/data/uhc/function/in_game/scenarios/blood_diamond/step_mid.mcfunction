...
$execute if score #random uhc.scenario.blood_diamond.temp matches 51..75 run tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamant (25%)","color":"#3FE7FF","bold":false}]
$execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamant pour ","color":"#FF3F3F","bold":false},{"selector":"@p[tag=uhc.blood_diamond.receive]","bold":false},{"text":" (25%)","color":"#FF3F3F","bold":false}]
execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @p[tag=uhc.blood_diamond.receive,scores={uhc.players.lang=061801}] [{"text":"Blood Diamond ","color":"#3FE7FF","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" Diamant reçu de ","color":"#3FE7FF","bold":false},{"selector":"@s","bold":false}]
...
$execute if score #random uhc.scenario.blood_diamond.temp matches 51..75 run tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamond (25%)","color":"#3FE7FF","bold":false}]
$execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @s[scores={uhc.players.lang=051407}] [{"text":"Blood Diamond ($(mined)/$(end_tier_2)) ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" +1 diamond for ","color":"#FF3F3F","bold":false},{"selector":"@p[tag=uhc.blood_diamond.receive]","bold":false},{"text":" (25%)","color":"#FF3F3F","bold":false}]
execute if score #random uhc.scenario.blood_diamond.temp matches 76..100 run tellraw @p[tag=uhc.blood_diamond.receive,scores={uhc.players.lang=051407}] [{"text":"Blood Diamond ","color":"#3FE7FF","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" Diamond received from ","color":"#3FE7FF","bold":false},{"selector":"@s","bold":false}]
