...
scoreboard players operation #minutes uhc.scenario.best_pve.tick /= #60 uhc.data.numbers
tellraw @p[scores={best_pve.list=0..}] [{"selector":"@s"},{"text":" ["},{"score":{"name":"#minutes","objective":"uhc.scenario.best_pve.tick"}},{"text":"m"},{"score":{"name":"#seconds","objective":"uhc.scenario.best_pve.tick"}},{"text":"s"},{"text":"]"}]
