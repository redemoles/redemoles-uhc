...
# Msg FRA
tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Vous êtes en dessous de y=150 !","color":"#FF3F3F"}]

# Msg ENG
tellraw @s[scores={uhc.players.lang=051407}] [{"text":"You are below y=150!","color":"#FF3F3F"}]
