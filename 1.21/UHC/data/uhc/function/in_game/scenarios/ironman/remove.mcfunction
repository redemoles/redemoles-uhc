...
execute if score #seconds uhc.data.temp matches 10.. run tellraw @a[scores={uhc.players.lang=1}] [{"text":"Ironman ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" ","color":"#FFFFFF"},{"selector":"@s"},{"text":" n'est plus Ironman. [","color":"#FF3F3F"},{"score":{"name":"#minutes","objective":"uhc.data.temp"},"color":"#FF3F3F"},{"text":"m","color":"#FF3F3F"},{"score":{"name":"#seconds","objective":"uhc.data.temp"},"color":"#FF3F3F"},{"text":"s]","color":"#FF3F3F"}]
execute if score #seconds uhc.data.temp matches ..09 run tellraw @a[scores={uhc.players.lang=1}] [{"text":"Ironman ","color":"#FFE73F","bold":false},{"text":">","color":"#9F9F9F","bold":true},{"text":" ","color":"#FFFFFF"},{"selector":"@s"},{"text":" n'est plus Ironman. [","color":"#FF3F3F"},{"score":{"name":"#minutes","objective":"uhc.data.temp"},"color":"#FF3F3F"},{"text":"m0","color":"#FF3F3F"},{"score":{"name":"#seconds","objective":"uhc.data.temp"},"color":"#FF3F3F"},{"text":"s]","color":"#FF3F3F"}]
