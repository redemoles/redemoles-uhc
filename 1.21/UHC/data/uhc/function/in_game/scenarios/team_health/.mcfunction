...
execute if score #hp_tab uhc.data.setup matches 3 store result score #players uhc.scenario.team_health.team if entity @a[predicate=uhc:id_teams]
...
scoreboard players operation @s uhc.players.health.100 = #health uhc.players.health.100
