...
# Msg FRA
tellraw @s[scores={uhc.players.lang=1}] [{"text":"Vous n'êtes pas dans le Nether !","color":"#FF3F3F"}]

# Msg ENG
tellraw @s[scores={uhc.players.lang=2}] [{"text":"You are not in the Nether!","color":"#FF3F3F"}]
