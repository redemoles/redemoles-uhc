...
execute store result storage uhc:settings respawn_location.720 int 0.02 run scoreboard players get #respawn_location_720 uhc.data.setup
execute store result storage uhc:settings respawn_location.840 int 0.02 run scoreboard players get #respawn_location_840 uhc.data.setup
execute store result storage uhc:settings respawn_location.360 int 0.02 run scoreboard players get #respawn_location_360 uhc.data.setup
execute store result storage uhc:settings respawn_location.960 int 0.02 run scoreboard players get #respawn_location_960 uhc.data.setup
