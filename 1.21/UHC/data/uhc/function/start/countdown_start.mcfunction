...
execute if score #tick_start uhc.data.setup matches 4 if score #bhc uhc.gamemode matches 1 if score #bhc bhc.scenario matches 0.. run title @a subtitle [{"text":" Démarrage en cours ! ","color":"white","bold":false}]
...
execute if score #tick_start uhc.data.setup matches 4 run execute if score #fte uhc.gamemode matches 1 run title @a title [{"text":"Fate","color":"#FFFFFF","bold":false},{"text":"UHC","color":"#E73F3F","bold":false}]
