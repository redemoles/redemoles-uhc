...
execute if entity @s[scores={uhc.players.lang=061801}] run tellraw @s [{"text":"Tu as déconnecté pendant un mini-jeu, tu as été retiré de la chambre.","color":"#FF3F3F"}]
execute if entity @s[scores={uhc.players.lang=051407}] run tellraw @s [{"text":"You disconnected during a mini-game, you've been removed from the chamber.","color":"#FF3F3F"}]
