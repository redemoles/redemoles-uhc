...
#> uhc:pre_game/players_and_teams/random_team/1_group/color
#
...
execute unless entity @s[tag=uhc.player,scores={uhc.id.teams=0}] as @r[tag=uhc.player,scores={uhc.id.teams=0}] run function uhc:pre_game/players_and_teams/random_team/1_group/color
