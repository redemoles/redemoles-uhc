...
execute if score #random_team_tick uhc.data.setup matches 0 if score #random_team_players uhc.data.setup matches 1.. as @r[tag=uhc.player,team=99] run function uhc:pre_game/players_and_teams/random_team/reveal/progressive_2
