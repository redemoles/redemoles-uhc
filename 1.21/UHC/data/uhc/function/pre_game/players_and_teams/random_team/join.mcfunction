...
#> uhc:pre_game/players_and_teams/random_team/join
#
...
#
tellraw @a[tag=host] [{"text":"","bold":false},{"text":"[Test]","bold":true},{"text":" Entrée function randomiseur en tant que "},{"selector":"@s"}]
...
execute if entity @a[predicate=uhc:random_team_ban] run function uhc:pre_game/players_and_teams/random_team/ban
