...
#> uhc:pre_game/players_and_teams/random_team/test/join
#
...
execute unless score @s uhc.id.random_teams.ban matches 100..399 run scoreboard players set #ban uhc.id.random_teams.ban -1
...
execute if entity @e[type=marker,predicate=uhc:random_team_ban] run function uhc:pre_game/players_and_teams/random_team/test/ban
