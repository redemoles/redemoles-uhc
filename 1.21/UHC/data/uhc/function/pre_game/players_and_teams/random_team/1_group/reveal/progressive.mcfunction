...
#> uhc:pre_game/players_and_teams/random_team/1_group/reveal/progressive
#
...
execute if score #random_team_tick uhc.data.setup matches 30 run function uhc:pre_game/players_and_teams/random_team/1_group/reveal/progressive_1

scoreboard players set #random_team_tick uhc.data.setup -1
execute if score #random_team_players uhc.data.setup matches 1.. as @r[tag=uhc.player,team=91] run return run function uhc:pre_game/players_and_teams/random_team/1_group/reveal/progressive_join
execute if score #random_team_players uhc.data.setup matches 1.. if entity @p[tag=uhc.player,team=91] run return fail
