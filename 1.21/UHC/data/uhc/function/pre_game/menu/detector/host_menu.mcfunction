...
execute if score #teams uhc.host.menu matches 1 if score #dru uhc.gamemode matches 1 run function uhc:pre_game/menu/selection/teams_gm_dru
execute if score #teams uhc.host.menu matches 1 if score #bhc uhc.gamemode matches 0 if score #dru uhc.gamemode matches 0 run function uhc:pre_game/menu/selection/teams_gm_vanilla
