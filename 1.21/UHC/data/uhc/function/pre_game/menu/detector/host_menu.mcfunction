...
execute if score #teams uhc.host.menu matches 1 if score #bhc uhc.gamemode matches 1 if score #bhc bhc.scenario matches 1.. run function uhc:pre_game/menu/selection/teams_gm_bhc_beta
