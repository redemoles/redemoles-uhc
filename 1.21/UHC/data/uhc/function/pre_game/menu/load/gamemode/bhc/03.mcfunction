...
data modify storage uhc:settings gamemode set value '[{"text":"Bingo","color":"#9F3FFF","bold":true,"italic":false},{"text":" UHC","color":"#FFE73F","bold":true,"italic":false},{"text":" - ","color":"#FFFFFF","bold":true},{"text":"BHC III","color":"#FFE73F","bold":true}]'
