...
execute unless score @s uhc.menu.scenarios.blood_diamond matches 1.. run scoreboard players set @s uhc.menu.scenarios.blood_diamond 1
...
execute if score #blood_diamond uhc.scenario matches 0 run item replace entity @s[scores={uhc.players.lang=061801}] inventory.1 with minecraft:red_concrete[minecraft:item_name=[{"text":"Blood Diamond","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"Désactivé","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario_blood_diamond_enable"}]
execute if score #blood_diamond uhc.scenario matches 1 run item replace entity @s[scores={uhc.players.lang=061801}] inventory.1 with minecraft:diamond_ore[minecraft:item_name=[{"text":"Blood Diamond","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Activé","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario_blood_diamond_enable"}]

execute if score #blood_diamond uhc.scenario matches 0 run item replace entity @s[scores={uhc.players.lang=051407}] inventory.1 with minecraft:red_concrete[minecraft:item_name=[{"text":"Blood Diamond","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"Disabled","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario_blood_diamond_enable"}]
execute if score #blood_diamond uhc.scenario matches 1 run item replace entity @s[scores={uhc.players.lang=051407}] inventory.1 with minecraft:diamond_ore[minecraft:item_name=[{"text":"Blood Diamond","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Enabled","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario_blood_diamond_enable"}]
...
execute if score @s uhc.menu.scenarios.blood_diamond matches 2.. run item replace entity @s inventory.21 with minecraft:magenta_concrete[minecraft:item_name=[{"text":"-1","color":"#FF3F3F","italic":false}],minecraft:custom_data={Tags:"-1"}]
execute if score @s uhc.menu.scenarios.blood_diamond matches 2.. run item replace entity @s inventory.23 with minecraft:light_blue_concrete[minecraft:item_name=[{"text":"+1","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"+1"}]
