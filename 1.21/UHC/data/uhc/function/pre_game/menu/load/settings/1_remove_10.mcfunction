...
execute if score #settings_pve uhc.host.menu matches 1 run scoreboard players remove #pve uhc.data.setup 10
execute if score #settings_pve uhc.host.menu matches 1 if score #pve uhc.data.setup matches ..0 run scoreboard players set #pve uhc.data.setup 0

# Période sans PvP
execute if score #settings_pvp uhc.host.menu matches 1 run scoreboard players remove #pvp uhc.data.setup 10
execute if score #settings_pvp uhc.host.menu matches 1 if score #pvp uhc.data.setup matches ..0 run scoreboard players set #pvp uhc.data.setup 0
...
execute if score #settings_pvp uhc.host.menu matches 2 run scoreboard players remove #shield_percent uhc.data.setup 10
execute if score #settings_pvp uhc.host.menu matches 2 if score #shield_percent uhc.data.setup matches ..0 run scoreboard players set #shield_percent uhc.data.setup 0

# Border - Taille initiale
execute if score #settings_border uhc.host.menu matches 1 run scoreboard players remove #border_size_start uhc.data.setup 50

# Meet-up - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 11 run scoreboard players remove #border_size_start uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 12 run scoreboard players remove #border_size_end uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 13 run scoreboard players remove #border uhc.data.setup 10

# Shrink 1 - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 21 run scoreboard players remove #border_size_end uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 22 run scoreboard players remove #shrink1_size_end uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 23 run scoreboard players remove #shrink1 uhc.data.setup 10

# Shrink 2 - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 31 run scoreboard players remove #shrink1_size_end uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 32 run scoreboard players remove #shrink2_size_end uhc.data.setup 50
execute if score #settings_border uhc.host.menu matches 33 run scoreboard players remove #shrink2 uhc.data.setup 10
...
execute if score #settings_border uhc.host.menu matches 14 run scoreboard players remove #border_length uhc.data.setup 10
...
execute if score #settings_border uhc.host.menu matches 1.. run scoreboard players operation #temp uhc.data.setup -= #shrink1 uhc.data.setup
execute if score #settings_border uhc.host.menu matches 24 run scoreboard players remove #shrink1_length uhc.data.setup 10
...
execute if score #settings_border uhc.host.menu matches 34 run scoreboard players remove #shrink2_length uhc.data.setup 10
