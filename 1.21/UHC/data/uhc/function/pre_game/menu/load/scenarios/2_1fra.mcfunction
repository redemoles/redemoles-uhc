...
execute if score #shared_health uhc.scenario matches 0 run item replace entity @s inventory.2 with minecraft:black_concrete[minecraft:item_name=[{"text":"Shared Health","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"Points de vie partagés entre tous les joueurs d'une équipe.","color":"#FFFFFF","italic":false}]]]
execute if score #shared_health uhc.scenario matches 1 run item replace entity @s inventory.2 with minecraft:black_concrete[minecraft:item_name=[{"text":"Shared Health","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"Points de vie partagés entre tous les joueurs d'une équipe.","color":"#FFFFFF","italic":false}]]]
...
execute if score #sky_high uhc.scenario matches 1 run item replace entity @s inventory.3 with minecraft:phantom_membrane[minecraft:item_name=[{"text":"Sky High","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"À l'activation du PvP, les joueurs en dessous de Y=150 recevront","color":"#FFFFFF","italic":false}],[{"text":"des dégâts progressifs toutes les 30 secondes.","color":"#FFFFFF","italic":false}],[{"text":"Incompatible avec ","color":"#FF7F7F","italic":false},{"text":"Go To Hell","color":"#FF3F3F","italic":false}]]]
execute if score #sound_paranoia uhc.scenario matches 0 run item replace entity @s inventory.4 with minecraft:red_concrete[minecraft:item_name=[{"text":"Sound Paranoia","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"Chaque joueur entendra un faux son toutes les 1m30 à 7m30.","color":"#FFFFFF","italic":false}]]]
execute if score #sound_paranoia uhc.scenario matches 1 run item replace entity @s inventory.4 with minecraft:note_block[minecraft:item_name=[{"text":"Sound Paranoia","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Chaque joueur entendra un faux son toutes les 1m30 à 7m30.","color":"#FFFFFF","italic":false}]]]
