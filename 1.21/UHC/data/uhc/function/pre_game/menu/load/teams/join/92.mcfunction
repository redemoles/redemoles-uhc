...
tellraw @s[scores={uhc.players.lang=061801}] [{"text":"Tu as rejoint les ","color":"#3FE7FF","bold":false},{"text":"Joueurs (Groupe A)","color":"#3F57FF","bold":false}]
tellraw @s[scores={uhc.players.lang=051407}] [{"text":"You joined the ","color":"#3FE7FF","bold":false},{"text":"Players (Group A)","color":"#3F57FF","bold":false}]
