...
execute in uhc:sign run data modify block 0 0 0 front_text.messages[1] set value [{"text":""},{"selector":"@p[tag=menu.players,tag=uhc.spec]","color":"#3FE7FF","bold":true},{"text":" "}]
