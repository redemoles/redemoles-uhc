...
execute unless score #bhc bhc.scenario matches 5 run item replace entity @s inventory.5 with minecraft:black_concrete[minecraft:item_name='{"text":"BHC V","color":"#5FFF5F","italic":false}']
execute unless score #bhc bhc.scenario matches 6 run item replace entity @s inventory.6 with minecraft:black_concrete[minecraft:item_name='{"text":"BHC VI","color":"#FFFF5F","italic":false}']
execute unless score #bhc bhc.scenario matches 7 run item replace entity @s inventory.7 with minecraft:black_concrete[minecraft:item_name='{"text":"BHC VII","color":"#FFAF5F","italic":false}']
...
execute if score #bhc bhc.scenario matches 5 run item replace entity @s inventory.5 with minecraft:lime_concrete[minecraft:item_name='{"text":"BHC V","color":"#5FFF5F","italic":false}',lore=['{"text":"Sélectionné","color":"#3FE7FF","italic":false}'],minecraft:enchantment_glint_override=true]
execute if score #bhc bhc.scenario matches 6 run item replace entity @s inventory.6 with minecraft:yellow_concrete[minecraft:item_name='{"text":"BHC VI","color":"#FFFF5F","italic":false}',lore=['{"text":"Sélectionné","color":"#3FE7FF","italic":false}'],minecraft:enchantment_glint_override=true]
execute if score #bhc bhc.scenario matches 7 run item replace entity @s inventory.7 with minecraft:orange_concrete[minecraft:item_name='{"text":"BHC VII","color":"#FFAF5F","italic":false}',lore=['{"text":"Sélectionné","color":"#3FE7FF","italic":false}'],minecraft:enchantment_glint_override=true]
execute if score #bhc bhc.scenario matches 8 run item replace entity @s inventory.10 with minecraft:red_concrete[minecraft:item_name='{"text":"BHC VIII","color":"#FF5F5F","italic":false}',lore=['{"text":"Sélectionné","color":"#3FE7FF","italic":false}'],minecraft:enchantment_glint_override=true]
execute if score #bhc bhc.scenario matches 0 run item replace entity @s inventory.16 with minecraft:white_concrete[minecraft:item_name='{"text":"BHC Vanilla","color":"#FFFFFF","italic":false}',lore=['{"text":"Sélectionné","color":"#3FE7FF","italic":false}'],minecraft:enchantment_glint_override=true]
