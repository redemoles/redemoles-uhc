...
#> uhc:pre_game/menu/load/world_generation/overworld/8000
#
# @within			uhc:pre_game/menu/selection/
#
#
# @description		Génération du monde en 8000x8000
#

scoreboard players set #overworld_working pregen.world 0
scoreboard players set #the_nether_working pregen.world 8
