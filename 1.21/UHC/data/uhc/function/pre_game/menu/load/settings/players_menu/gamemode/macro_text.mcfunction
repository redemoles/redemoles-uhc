...
$execute if score #vanilla uhc.gamemode matches 1 run item replace entity @s[scores={uhc.players.lang=1}] inventory.19 with minecraft:command_block[minecraft:item_name='[{"text":"Mode de jeu","color":"#FF3F3F","italic":false}]',minecraft:lore=['$(gamemode)']]
$execute if score #vanilla uhc.gamemode matches 1 run item replace entity @s[scores={uhc.players.lang=2}] inventory.19 with minecraft:command_block[minecraft:item_name='[{"text":"Gamemode","color":"#FF3F3F","italic":false}]',minecraft:lore=['$(gamemode)']]
