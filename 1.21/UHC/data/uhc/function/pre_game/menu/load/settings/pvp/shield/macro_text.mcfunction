...
$execute if score #settings_pvp uhc.host.menu matches 1.. run item replace entity @s inventory.12 with minecraft:shield[minecraft:item_name='[{"text":"Durabilité des boucliers : ","color":"#CFCFCF","italic":false},$(interpreted_2),{"text":"%","color":"#CFCFCF","italic":false}]',damage=$(durability)]
