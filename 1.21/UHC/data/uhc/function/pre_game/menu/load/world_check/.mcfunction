...
item replace entity @s[tag=host.check_biomes] inventory.1 with minecraft:moss_block[minecraft:item_name='{"text":"Vérification des Biomes","color":"#FFE73F","italic":false}',minecraft:enchantments={levels:{'minecraft:lure':0}}]
...
item replace entity @s[tag=host.check_spawns] inventory.2 with minecraft:ender_pearl[minecraft:item_name='{"text":"Vérification des Spawns","color":"#FFE73F","italic":false}',minecraft:enchantments={levels:{'minecraft:lure':0}}]
