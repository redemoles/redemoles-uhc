...
scoreboard players set #shrink_1 uhc.data.setup 600
scoreboard players set #shrink_2 uhc.data.setup 600
scoreboard players set #shrink_3 uhc.data.setup 600
...
scoreboard players set #shrink_1_size_end uhc.data.setup 3000
scoreboard players set #shrink_2_size_end uhc.data.setup 3000
scoreboard players set #shrink_3_size_end uhc.data.setup 3000
