...
execute unless score #lobby lobby.data matches 1 run item replace entity @s inventory.1 with minecraft:granite[minecraft:item_name=[{"text":"BHC I","color":"#FF3F3F","italic":false}],minecraft:custom_data={"Tags":"lobby_01"}]
execute if score #lobby lobby.data matches 1 run item replace entity @s inventory.1 with minecraft:granite[minecraft:item_name=[{"text":"BHC I","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Sélectionné","color":"#3FE7FF","italic":false}]],minecraft:custom_data={"Tags":"lobby_01"},minecraft:enchantment_glint_override=true]
