...
execute if score #lobby lobby.data matches 0 run item replace entity @s inventory.1 with minecraft:magenta_concrete_powder[minecraft:item_name='{"text":"Beta","color":"#3FFFFF","italic":false}',lore=['{"text":"Sélectionné","color":"#3FFFFF","italic":false}'],minecraft:enchantments={}]
execute if score #lobby lobby.data matches 1 run item replace entity @s inventory.2 with minecraft:granite[minecraft:item_name='{"text":"BHC I","color":"#3FFFFF","italic":false}',lore=['{"text":"Sélectionné","color":"#3FFFFF","italic":false}'],minecraft:enchantments={}]
