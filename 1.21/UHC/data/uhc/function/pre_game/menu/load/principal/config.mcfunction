...
tellraw @s [{"text":"Mode de jeu :","color":"#3F9FFF","bold":true}]
execute if score #vanilla uhc.gamemode matches 1 run tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"Vanilla","color":"#E7E7E7","bold":false}]
