...
tellraw @s[tag=host.world_generation.2000] [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"1000/-1000","color":"#3FE7FF","bold":false}]
tellraw @s[tag=!host.world_generation.4000] [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"2000/-2000","color":"#CF3F3F","bold":false}]
tellraw @s[tag=host.world_generation.4000] [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"2000/-2000","color":"#3FE7FF","bold":false}]
