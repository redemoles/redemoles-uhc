...
execute if score #shared_health uhc.scenario matches 0 run item replace entity @s inventory.1 with minecraft:black_concrete[minecraft:item_name='{"text":"Shared Health","color":"#FF3F3F","italic":false}',minecraft:lore=['[{"text":"Health points shared between all players of a team.","color":"#FFFFFF","italic":false}]']]
execute if score #shared_health uhc.scenario matches 1 run item replace entity @s inventory.1 with minecraft:black_concrete[minecraft:item_name='{"text":"Shared Health","color":"#FF3F3F","italic":false}',minecraft:lore=['[{"text":"Health points shared between all players of a team.","color":"#FFFFFF","italic":false}]']]
...
execute if score #team_health uhc.scenario matches 1 run item replace entity @s inventory.3 with minecraft:apple[minecraft:item_name='{"text":"Team Health","color":"#3FE7FF","italic":false}',minecraft:lore=['[{"text":"The health points shown correspond to","color":"#FFFFFF","italic":false}]','[{"text":"combined health of all players of the team.","color":"#FFFFFF","italic":false}]']]
