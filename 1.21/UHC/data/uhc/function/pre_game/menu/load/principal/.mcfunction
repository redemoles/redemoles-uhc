...
item replace entity @s[scores={uhc.players.lang=1}] inventory.19 with minecraft:book[minecraft:item_name=[{"text":"Résumé configuration","color":"#3FE7FF","italic":false}],minecraft:lore=[{"text":"Menu Paramètres exclu","color":"#CFCFCF"}],minecraft:custom_data={Tags:"rules_summary"}]
...
item replace entity @s[scores={uhc.players.lang=2}] inventory.19 with minecraft:book[minecraft:item_name=[{"text":"Settings configuration","color":"#3FE7FF","italic":false}],minecraft:lore=[{"text":"Settings menu excluded","color":"#CFCFCF"}],minecraft:custom_data={Tags:"rules_summary"}]
