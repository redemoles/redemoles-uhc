...
execute if score #dru uhc.gamemode matches 1 run tellraw @s[scores={uhc.players.lang=1}] [{"text":"Tu viens de rejoindre les ","color":"#9F3FFF","bold":false}, {"text":"Spectateurs","color":"#BF7FFF"}]
...
execute if score #dru uhc.gamemode matches 1 run tellraw @s[scores={uhc.players.lang=2}] [{"text":"You joined the ","color":"#9F3FFF","bold":false}, {"text":"Spectators","color":"#BF7FFF"}]
