...
execute if score @s uhc.menu.settings.pve matches 1 unless score #pve uhc.data.setup matches ..0 run scoreboard players remove #pve uhc.data.setup 1


# Absorption
execute if score @s uhc.menu.settings.pve matches 2 unless score #absorption uhc.data.setup matches ..0 run scoreboard players remove #absorption uhc.data.setup 1

# Période sans PvP
execute if score @s uhc.menu.settings.pvp matches 1 unless score #pvp uhc.data.setup matches ..0 run scoreboard players remove #pvp uhc.data.setup 1


# Durabilité des boucliers
execute if score @s uhc.menu.settings.pvp matches 2 unless score #shield_percent uhc.data.setup matches ..0 run scoreboard players remove #shield_percent uhc.data.setup 1


# Régénération après kill
execute if score @s uhc.menu.settings.pvp matches 3 unless score #reward_kill_health uhc.data.setup matches ..0 run scoreboard players remove #reward_kill_health uhc.data.setup 1

# Limite de loups
execute if score @s uhc.menu.settings.pvp matches 4 unless score #wolf_count uhc.data.setup matches ..0 run scoreboard players remove #wolf_count uhc.data.setup 1


# Border - Taille initiale
execute if score @s uhc.menu.settings.border matches 1 run scoreboard players remove #shrink_1_size_start uhc.data.setup 2

# Meet-up - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.settings.border matches 11 run scoreboard players remove #shrink_1_size_start uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 12 run scoreboard players remove #shrink_1_size_end uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 13 run scoreboard players remove #shrink_1 uhc.data.setup 1

# Shrink 1 - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.settings.border matches 21 run scoreboard players remove #shrink_1_size_end uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 22 run scoreboard players remove #shrink_2_size_end uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 23 run scoreboard players remove #shrink_2 uhc.data.setup 1

# Shrink 2 - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.settings.border matches 31 run scoreboard players remove #shrink_2_size_end uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 32 run scoreboard players remove #shrink_3_size_end uhc.data.setup 2
execute if score @s uhc.menu.settings.border matches 33 run scoreboard players remove #shrink_3 uhc.data.setup 1
...
execute if score @s uhc.menu.settings.border matches 14 unless score #shrink_1_length uhc.data.setup matches ..0 run scoreboard players remove #shrink_1_length uhc.data.setup 1


# Shrink 1 - Temps de réduction
execute if score @s uhc.menu.settings.border matches 24 unless score #shrink_2_length uhc.data.setup matches ..0 run scoreboard players remove #shrink_2_length uhc.data.setup 1
...
execute if score @s uhc.menu.settings.inventory matches 14 unless score #iron_protection uhc.data.setup matches ..0 run scoreboard players remove #iron_protection uhc.data.setup 1
execute if score @s uhc.menu.settings.inventory matches 15 unless score #iron_sharpness uhc.data.setup matches ..0 run scoreboard players remove #iron_sharpness uhc.data.setup 1
execute if score @s uhc.menu.settings.inventory matches 16 unless score #axes_sharpness uhc.data.setup matches ..0 run scoreboard players remove #axes_sharpness uhc.data.setup 1
execute if score @s uhc.menu.settings.inventory matches 17 unless score #bow_power uhc.data.setup matches ..0 run scoreboard players remove #bow_power uhc.data.setup 1
execute if score @s uhc.menu.settings.inventory matches 22 unless score #depth_strider uhc.data.setup matches ..0 run scoreboard players remove #depth_strider uhc.data.setup 1
