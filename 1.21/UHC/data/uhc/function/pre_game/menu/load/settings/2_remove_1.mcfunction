...
execute if score @s uhc.menu.host.settings.border matches 14 unless score #shrink_1_length uhc.data.setup matches ..0 run scoreboard players remove #shrink_1_length uhc.data.setup 1


# Shrink 1 - Temps de réduction
execute if score @s uhc.menu.host.settings.border matches 24 unless score #shrink_2_length uhc.data.setup matches ..0 run scoreboard players remove #shrink_2_length uhc.data.setup 1


# Shrink 2 - Temps de réduction
execute if score @s uhc.menu.host.settings.border matches 34 unless score #shrink_3_length uhc.data.setup matches ..0 run scoreboard players remove #shrink_3_length uhc.data.setup 1
