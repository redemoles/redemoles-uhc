...
data modify block 0 0 0 front_text.messages[2] set value '{"score":{"name":"#shield_percent","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true}'
data modify block 0 0 0 front_text.messages[3] set value '{"score":{"name":"#shield","objective":"uhc.data.setup"}}'
