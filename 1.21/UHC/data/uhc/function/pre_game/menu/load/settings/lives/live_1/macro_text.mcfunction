...
$execute if score #settings_lives uhc.host.menu matches 2 run item replace entity @s inventory.22 with minecraft:red_candle[minecraft:item_name='[{"text":"Descente à 1 vie : ","color":"#FF3FFF","italic":false},$(interpreted_2),{"text":" minutes","color":"#FF3FFF","italic":false}]']
