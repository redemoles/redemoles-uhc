...
execute if score #settings_border uhc.host.menu matches 33 run data modify block 0 0 0 front_text.messages[2] set value '{"score":{"name":"#shrink2","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score #settings_border uhc.host.menu matches 34 run data modify block 0 0 0 front_text.messages[3] set value '{"score":{"name":"#shrink2_length","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score #settings_border uhc.host.menu matches 31 run data modify block 0 0 0 front_text.messages[0] set value '{"score":{"name":"#shrink1_size_end","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score #settings_border uhc.host.menu matches 32 run data modify block 0 0 0 front_text.messages[1] set value '{"score":{"name":"#shrink2_size_end","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
