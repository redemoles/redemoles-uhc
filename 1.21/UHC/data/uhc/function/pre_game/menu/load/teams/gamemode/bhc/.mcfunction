...
item replace entity @s[tag=uhc.player.night_vision,scores={uhc.players.lang=1}] inventory.24 with minecraft:light[minecraft:item_name='{"text":"Vision nocturne","color":"#3FE7FF","italic":false,"bold":true}',minecraft:lore=['{"text":"Clique pour désactiver","color":"#FFE73F","italic":false,"bold":false}','{"text":"Désactivé pour certains modes de jeu","color":"#E7E7E7","italic":true,"bold":false}'],minecraft:hide_additional_tooltip={},block_state={level:"15"}]
...
item replace entity @s inventory.25 with minecraft:book[minecraft:item_name='{"text":"Configuration de la partie","color":"#3FE7FF","bold":true,"italic":false}']
