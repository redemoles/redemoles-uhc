...
execute if score @s uhc.menu.host.settings.border matches 23 run data modify block 0 0 0 front_text.messages[2] set value '{"score":{"name":"#shrink1","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score @s uhc.menu.host.settings.border matches 24 run data modify block 0 0 0 front_text.messages[3] set value '{"score":{"name":"#shrink1_length","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score @s uhc.menu.host.settings.border matches 21 run data modify block 0 0 0 front_text.messages[0] set value '{"score":{"name":"#border_size_end","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
execute if score @s uhc.menu.host.settings.border matches 22 run data modify block 0 0 0 front_text.messages[1] set value '{"score":{"name":"#shrink1_size_end","objective":"uhc.data.setup"},"color":"#FF3F3F","bold":true,"italic":false}'
