...
execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=1}] inventory.11 with minecraft:chest[minecraft:item_name=[{"text":"Items au démarrage","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Attention :","color":"#FF3F3F"},{"text":" Si le mode de jeu est changé, les modifications seront réinitialisés","color":"#FFFFFF"}],[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Fonctionnalité incompatible avec ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_starter"}]
execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=2}] inventory.11 with minecraft:chest[minecraft:item_name=[{"text":"Starter items","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Attention :","color":"#FF3F3F"},{"text":" If the game mode is changed, the changes will be reset","color":"#FFFFFF"}],[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Feature incompatible with ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_starter"}]

execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=1}] inventory.12 with minecraft:golden_apple[minecraft:item_name=[{"text":"Récompenses Ironman","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Récompenses pour le dernier joueur à garder tous ces PV","color":"#FFFFFF"}],[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Fonctionnalité incompatible avec ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_ironman"}]
execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=2}] inventory.12 with minecraft:golden_apple[minecraft:item_name=[{"text":"Ironman rewards","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Rewards for the last player to keep all these HP","color":"#FFFFFF"}],[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Feature incompatible with ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_ironman"}]

execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=1}] inventory.13 with minecraft:totem_of_undying[minecraft:item_name=[{"text":"Compensation à la suppression de Pomme de Notch et Totem de resurrection","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Fonctionnalité désactivé pour ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_notch_totem"}]
execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=2}] inventory.13 with minecraft:totem_of_undying[minecraft:item_name=[{"text":"Compensation for the removal of Notch apple and Totem of undying","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Feature disabled for ","color":"#FF7F7F"},{"text":"All Items ","color":"#3FE7FF"},{"text":"Rush","color":"#FFE73F"}]],minecraft:custom_data={Tags:"settings_inventory_item_notch_totem"}]

execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=1}] inventory.14 with minecraft:dropper[minecraft:item_name=[{"text":"Items additionnels à la mort d'un joueur","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" S'applique à la mort d'un joueur, sauf si","color":"#FFFFFF"}],[{"text":"mort non définitive avant l'activation du PvP","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"settings_inventory_item_additional"}]
execute if score @s uhc.menu.host.settings.inventory matches 1.. run item replace entity @s[scores={uhc.players.lang=2}] inventory.14 with minecraft:dropper[minecraft:item_name=[{"text":"Additionnal items at the death of a player","color":"#FFE73F","italic":false}],minecraft:lore=[[{"text":"•","color":"#FF3F3F","italic":false},{"text":" Applies to the death of a player, except if","color":"#FFFFFF"}],[{"text":"non-definitive death before PvP is activated","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"settings_inventory_item_additional"}]
