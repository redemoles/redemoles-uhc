...
execute unless score #bhc bhc.scenario matches 99 run tellraw @a [{"text":"Bingo","color":"#B73FFF","bold":true},{"text":" UHC Run","color":"#FFE73F","bold":true},{"text":" activé","color":"#3FE7FF","bold":false}]
...
scoreboard players set #shrink_1_size_end uhc.data.setup 250
