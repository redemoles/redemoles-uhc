...
#> uhc:pre_game/menu/load/gamemode/bhc/99
#
...
data modify storage uhc:settings gamemode set value [{"text":"Bingo","color":"#9F3FFF","bold":true},{"text":" UHC Run","color":"#FFE73F","bold":true,"italic":false}]
scoreboard players set #bhc uhc.gamemode 1
scoreboard players set #bhc bhc.scenario 99
execute if score #bhc bhc.scenario matches 99 run tellraw @a [{"text":"Bingo","color":"#9F3FFF","bold":true},{"text":" UHC Run","color":"#FFE73F","bold":true},{"text":" activé","color":"#3FE7FF","bold":false}]

## UHC → Préparation Config pre-game
scoreboard players set #pve uhc.data.setup 2
scoreboard players set #pvp uhc.data.setup 31
scoreboard players set #shrink_1 uhc.data.setup 30
scoreboard players set #shrink_2 uhc.data.setup 35
scoreboard players set #shrink_3 uhc.data.setup 45
