...
execute if score #nzl uhc.gamemode matches 0 run item replace entity @s inventory.3 with minecraft:red_concrete[minecraft:item_name='{"text":"Nuzlocke UHC","color":"#FF3F3F","italic":false}']
execute if score #nzl uhc.gamemode matches 1 run item replace entity @s inventory.3 with minecraft:light_blue_concrete[minecraft:item_name='{"text":"Nuzlocke UHC","color":"#3FFFFF","italic":false}']
execute if score #nzl uhc.gamemode matches 1 if score #type_start nzl.data matches 0 run item replace entity @s inventory.11 with minecraft:light_blue_candle[minecraft:item_name='{"text":"Évolution au choix","color":"#3FFFFF","italic":false}']
execute if score #nzl uhc.gamemode matches 1 if score #type_start nzl.data matches 1 run item replace entity @s inventory.11 with minecraft:red_candle[minecraft:item_name='{"text":"Random Évolution au Start","color":"#FF3F3F","italic":false}']
