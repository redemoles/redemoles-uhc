...
execute if score #dru uhc.gamemode matches 1 run item replace entity @s inventory.2 with minecraft:black_concrete[minecraft:item_name='{"text":"Dragon UHC","color":"#3FE7FF","italic":false}']
...
execute if score #mls uhc.gamemode matches 1 run item replace entity @s inventory.4 with minecraft:black_concrete[minecraft:item_name='{"text":"Moles","color":"#3FE7FF","italic":false}']
...
execute if score #nzl uhc.gamemode matches 1 run item replace entity @s inventory.5 with minecraft:black_concrete[minecraft:item_name='{"text":"Nuzlocke UHC","color":"#3FE7FF","italic":false}']
...
execute if score #prv uhc.gamemode matches 1 run item replace entity @s inventory.6 with minecraft:black_concrete[minecraft:item_name='{"text":"PRV UHC","color":"#3FE7FF","italic":false}']
...
execute if score #uau uhc.gamemode matches 1 run item replace entity @s inventory.7 with minecraft:black_concrete[minecraft:item_name='{"text":"Ultra Arrow UHC","color":"#3FE7FF","italic":false}']
