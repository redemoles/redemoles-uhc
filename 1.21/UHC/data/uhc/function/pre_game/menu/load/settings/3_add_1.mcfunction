...
# Absorption
execute if score @s uhc.menu.host.settings.pvp matches 3 unless score #absorption uhc.data.setup matches 2.. run scoreboard players add #absorption uhc.data.setup 1

# Border - Taille initiale
execute if score @s uhc.menu.host.settings.border matches 1 run scoreboard players add #border_size_start uhc.data.setup 2

# Meet-up - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.host.settings.border matches 11 run scoreboard players add #border_size_start uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 12 run scoreboard players add #border_size_end uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 13 run scoreboard players add #border uhc.data.setup 1

# Shrink 1 - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.host.settings.border matches 21 run scoreboard players add #border_size_end uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 22 run scoreboard players add #shrink1_size_end uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 23 run scoreboard players add #shrink1 uhc.data.setup 1

# Shrink 2 - Taille initiale, Taille finale, Temps début de réduction
execute if score @s uhc.menu.host.settings.border matches 31 run scoreboard players add #shrink1_size_end uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 32 run scoreboard players add #shrink2_size_end uhc.data.setup 2
execute if score @s uhc.menu.host.settings.border matches 33 run scoreboard players add #shrink2 uhc.data.setup 1
...
execute if score @s uhc.menu.host.settings.border matches 14 run scoreboard players add #border_length uhc.data.setup 1
...
execute if score @s uhc.menu.host.settings.border matches 1.. run scoreboard players operation #temp uhc.data.setup -= #shrink1 uhc.data.setup
execute if score @s uhc.menu.host.settings.border matches 24 run scoreboard players add #shrink1_length uhc.data.setup 1
...
execute if score @s uhc.menu.host.settings.border matches 1.. run scoreboard players operation #temp uhc.data.setup -= #shrink2 uhc.data.setup
execute if score @s uhc.menu.host.settings.border matches 34 run scoreboard players add #shrink2_length uhc.data.setup 1
