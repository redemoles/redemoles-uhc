...
execute if score #settings_pve uhc.host.menu matches 1 unless score #pve uhc.data.setup matches 300.. run scoreboard players add #pve uhc.data.setup 1
...
# Période sans PvP
execute if score #settings_pvp uhc.host.menu matches 1 unless score #pvp uhc.data.setup matches 300.. run scoreboard players add #pvp uhc.data.setup 1


# Durabilité des boucliers
execute if score #settings_pvp uhc.host.menu matches 2 unless score #shield_percent uhc.data.setup matches 100.. run scoreboard players add #shield_percent uhc.data.setup 1


# Border - Taille initiale
execute if score #settings_border uhc.host.menu matches 1 run scoreboard players add #border_size_start uhc.data.setup 2

# Meet-up - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 11 run scoreboard players add #border_size_start uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 12 run scoreboard players add #border_size_end uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 13 run scoreboard players add #border uhc.data.setup 1

# Shrink 1 - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 21 run scoreboard players add #border_size_end uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 22 run scoreboard players add #shrink1_size_end uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 23 run scoreboard players add #shrink1 uhc.data.setup 1

# Shrink 2 - Taille initiale, Taille finale, Temps début de réduction
execute if score #settings_border uhc.host.menu matches 31 run scoreboard players add #shrink1_size_end uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 32 run scoreboard players add #shrink2_size_end uhc.data.setup 2
execute if score #settings_border uhc.host.menu matches 33 run scoreboard players add #shrink2 uhc.data.setup 1
...
execute if score #settings_border uhc.host.menu matches 14 run scoreboard players add #border_length uhc.data.setup 1
...
execute if score #settings_border uhc.host.menu matches 1.. run scoreboard players operation #temp uhc.data.setup -= #shrink1 uhc.data.setup
execute if score #settings_border uhc.host.menu matches 24 run scoreboard players add #shrink1_length uhc.data.setup 1
...
execute if score #settings_border uhc.host.menu matches 34 run scoreboard players add #shrink2_length uhc.data.setup 1
