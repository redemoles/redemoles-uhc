...
$item replace entity @s[scores={uhc.players.lang=1,uhc.menu.host.settings.lives=3},tag=uhc.host] inventory.22 with minecraft:yellow_candle[minecraft:item_name=[{"text":"Descente à 2 vies : ","color":"#FFFFFF","italic":false},$(interpreted_2),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_2"}]
...
$item replace entity @s[scores={uhc.players.lang=2,uhc.menu.host.settings.lives=3},tag=uhc.host] inventory.22 with minecraft:yellow_candle[minecraft:item_name=[{"text":"Drop to 2 lifes : ","color":"#FFFFFF","italic":false},$(interpreted_2),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_2"}]
