...
$execute if score @s[tag=host] uhc.menu.host.settings.lives matches 3 run item replace entity @s inventory.22 with minecraft:yellow_candle[minecraft:item_name='[{"text":"Descente à 2 vies : ","color":"#FF3FFF","italic":false},$(interpreted_2),{"text":" minutes","color":"#FF3FFF","italic":false}]']
