...
execute if score #lobby lobby.data matches 0 if score #lobby uhc.host.menu matches 1 unless items entity @s inventory.1 *[minecraft:item_name='{"text":"Beta","color":"#3FFFFF","italic":false}'] run function uhc:pre_game/menu/load/lobby/00
...
execute if score #lobby lobby.data matches 1 if score #lobby uhc.host.menu matches 1 unless items entity @s inventory.2 *[minecraft:item_name='{"text":"BHC I","color":"#3FFFFF","italic":false}'] run function uhc:pre_game/menu/load/lobby/01
