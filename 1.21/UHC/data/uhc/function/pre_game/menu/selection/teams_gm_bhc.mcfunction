...
execute as @s[tag=host] if score #teams uhc.host.menu matches 1 run function uhc:pre_game/menu/load/teams/gamemode/bhc/
execute as @s[tag=!host] run function uhc:pre_game/menu/load/teams/gamemode/bhc/
