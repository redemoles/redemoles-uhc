...
execute unless score #dru uhc.gamemode matches 1 if score #random_team uhc.data.setup matches 2 unless items entity @s[scores={uhc.menu.host.settings=1..}] inventory.25 *[minecraft:custom_data={Tags:"menu_teams"}] run function uhc:pre_game/menu/load/teams/gamemode/vanilla_random/split
