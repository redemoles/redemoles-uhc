...
execute unless entity @s[scores={uhc.id.teams=99}] unless items entity @s[tag=uhc.random_team.in_a_team,scores={uhc.players.lang=061801}] inventory.12 *[minecraft:custom_data={Tags:"team_92"}] run tellraw @s [{"text":"Tu ne peux pas quitter ton équipe car elles ont déjà été générées.","color":"#FF3F3F","bold":false}]
execute unless entity @s[scores={uhc.id.teams=99}] unless items entity @s[tag=uhc.random_team.in_a_team,scores={uhc.players.lang=051407}] inventory.12 *[minecraft:custom_data={Tags:"team_92"}] run tellraw @s [{"text":"You can't leave your team because they've already been generated.","color":"#FF3F3F","bold":false}]
...
execute unless entity @s[scores={uhc.id.teams=99}] unless items entity @s[tag=uhc.random_team.in_a_team,scores={uhc.players.lang=061801}] inventory.13 *[minecraft:custom_data={Tags:"team_192"}] run tellraw @s [{"text":"Tu ne peux pas quitter ton équipe car elles ont déjà été générées.","color":"#FF3F3F","bold":false}]
execute unless entity @s[scores={uhc.id.teams=99}] unless items entity @s[tag=uhc.random_team.in_a_team,scores={uhc.players.lang=051407}] inventory.13 *[minecraft:custom_data={Tags:"team_192"}] run tellraw @s [{"text":"You can't leave your team because they've already been generated.","color":"#FF3F3F","bold":false}]
...
execute as @s[tag=uhc.menu.teams] run function uhc:pre_game/menu/load/teams/gamemode/vanilla_random/split
