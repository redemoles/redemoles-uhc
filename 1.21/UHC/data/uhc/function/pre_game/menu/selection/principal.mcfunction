...
execute unless items entity @s[tag=host.menu.principal] inventory.19 *[minecraft:custom_data={Tags:"rules_summary"}] run function uhc:pre_game/menu/load/principal/config with storage uhc:settings
...
execute unless items entity @s[tag=host.menu.principal] inventory.24 *[minecraft:custom_data={Tags:"menu_teams_settings"}] run function uhc:pre_game/menu/load/teams_settings/
