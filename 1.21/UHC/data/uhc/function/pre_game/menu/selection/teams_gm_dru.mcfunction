...
execute unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"team_07"}] run function uhc:pre_game/menu/load/teams/join/00
execute unless items entity @s inventory.14 *[minecraft:custom_data={Tags:"spectator"}] run function uhc:pre_game/menu/load/teams/join/spec
