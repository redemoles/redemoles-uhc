...
execute unless items entity @s[tag=host.menu.gamemode.bhc] inventory.1 *[minecraft:custom_data={Tags:"gamemode_bhc_01"}] run function uhc:pre_game/menu/load/gamemode/bhc/01
#execute unless items entity @s[tag=host.menu.gamemode.bhc] inventory.2 *[minecraft:custom_data={Tags:"gamemode_bhc_02"}] run function uhc:pre_game/menu/load/gamemode/bhc/02
#execute unless items entity @s[tag=host.menu.gamemode.bhc] inventory.3 *[minecraft:custom_data={Tags:"gamemode_bhc_03"}] run function uhc:pre_game/menu/load/gamemode/bhc/03
#execute unless items entity @s[tag=host.menu.gamemode.bhc] inventory.4 *[minecraft:custom_data={Tags:"gamemode_bhc_04"}] run function uhc:pre_game/menu/load/gamemode/bhc/04
#execute unless items entity @s[tag=host.menu.gamemode.bhc] inventory.5 *[minecraft:custom_data={Tags:"gamemode_bhc_05"}] run function uhc:pre_game/menu/load/gamemode/bhc/05
