...
execute if score #gamemode_bhc uhc.host.menu matches 1 unless items entity @s inventory.1 *[minecraft:item_name='{"text":"BHC I","color":"#5F5FFF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/bhc/01
execute if score #gamemode_bhc uhc.host.menu matches 1 unless items entity @s inventory.2 *[minecraft:item_name='{"text":"BHC II","color":"#5FAFFF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/bhc/02
execute if score #gamemode_bhc uhc.host.menu matches 1 unless items entity @s inventory.3 *[minecraft:item_name='{"text":"BHC III","color":"#5FFFFF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/bhc/03
execute if score #gamemode_bhc uhc.host.menu matches 1 unless items entity @s inventory.4 *[minecraft:item_name='{"text":"BHC IV","color":"#5FAF5F","italic":false}'] run function uhc:pre_game/menu/load/gamemode/bhc/04
execute if score #gamemode_bhc uhc.host.menu matches 1 unless items entity @s inventory.5 *[minecraft:item_name='{"text":"BHC V","color":"#5FFF5F","italic":false}'] run function uhc:pre_game/menu/load/gamemode/bhc/05
