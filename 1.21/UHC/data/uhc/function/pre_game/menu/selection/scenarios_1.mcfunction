...
# Ligne 3
execute if score #scenarios uhc.host.menu matches 1 unless items entity @s inventory.24 *[minecraft:item_name='{"text":"Page 2","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/scenarios/2
