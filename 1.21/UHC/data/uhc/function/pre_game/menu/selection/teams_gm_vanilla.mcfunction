...
execute as @s[tag=uhc.host,tag=host.menu.teams] run function uhc:pre_game/menu/load/teams/gamemode/vanilla/
execute as @s[tag=!uhc.host,tag=players.menu.teams] run function uhc:pre_game/menu/load/teams/gamemode/vanilla/
