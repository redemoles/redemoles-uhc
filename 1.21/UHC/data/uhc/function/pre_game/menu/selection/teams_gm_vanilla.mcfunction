...
execute unless items entity @s inventory.23 *[minecraft:item_name='{"text":"Spectateurs","color":"#BFBFBF","italic":false,"bold":true}'] run function uhc:pre_game/menu/load/teams/join/spec
...
execute unless items entity @s[tag=host.menu.teams,tag=players.menu.teams] inventory.25 *[minecraft:item_name='{"text":"Configuration de la partie","color":"#3FE7FF","bold":true,"italic":false}'] run function uhc:pre_game/menu/load/settings/players_menu/
execute as @s[tag=host,tag=host.menu.teams] run function uhc:pre_game/menu/load/teams/gamemode/vanilla/
execute as @s[tag=!host,tag=players.menu.teams] run function uhc:pre_game/menu/load/teams/gamemode/vanilla/
