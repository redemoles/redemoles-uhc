...
execute if score #nzl uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.4 *[minecraft:item_name='{"text":"Nuzlocke UHC","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/nzl/
execute if score #nzl uhc.gamemode matches 1 if score #type_start nzl.data matches 0 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.12 *[minecraft:item_name='{"text":"Évolution au choix","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/nzl/type
...
execute if score #prv uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.5 *[minecraft:item_name='{"text":"PRV UHC","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/prv/
...
execute if score #uau uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.6 *[minecraft:item_name='{"text":"Ultra Arrow UHC","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/uau/
