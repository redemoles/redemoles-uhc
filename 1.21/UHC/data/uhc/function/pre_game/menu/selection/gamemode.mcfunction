...
execute if score #prv uhc.gamemode matches 0 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.4 *[minecraft:item_name='{"text":"PRV UHC","color":"#FF3F3F","italic":false}'] run function uhc:pre_game/menu/load/gamemode/prv/
execute if score #prv uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.4 *[minecraft:item_name='{"text":"PRV UHC","color":"#3FFFFF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/prv/
execute if score #uau uhc.gamemode matches 0 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.5 *[minecraft:item_name='{"text":"Ultra Arrow UHC","color":"#FF3F3F","italic":false}'] run function uhc:pre_game/menu/load/gamemode/uau/
execute if score #uau uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless items entity @s inventory.5 *[minecraft:item_name='{"text":"Ultra Arrow UHC","color":"#3FFFFF","italic":false}'] run function uhc:pre_game/menu/load/gamemode/uau/
