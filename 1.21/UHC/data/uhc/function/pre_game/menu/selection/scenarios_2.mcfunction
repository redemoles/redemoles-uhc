...
# Ligne 3
execute if score #scenarios uhc.menu.host matches 2 unless items entity @s inventory.24 *[minecraft:item_name='{"text":"Page 1","color":"#3FE7FF","italic":false}'] run function uhc:pre_game/menu/load/scenarios/1
execute if score #scenarios uhc.menu.host matches 2 unless items entity @s inventory.25 *[minecraft:item_name='{"text":"FERMER","color":"#FF3F3F","italic":false}'] run function uhc:pre_game/menu/load/principal/
execute if score #scenarios uhc.menu.host matches 2 run function uhc:pre_game/menu/load/scenarios/2
