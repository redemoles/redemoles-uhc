...
execute unless score #end uhc.game.end matches 1.. run tellraw @s[scores={uhc.players.lang=1}] [{"text":"\nForcer la fin de la partie ?","color":"#FF3F3F","bold":true,"clickEvent":{"action":"run_command","value":"/trigger uhc.game.end add 1"}},{"text":"\nVALIDER\n","color":"#CF3F3F"}]
execute unless score #end uhc.game.end matches 1.. run tellraw @s[scores={uhc.players.lang=2}] [{"text":"\nForce the end of the game?","color":"#FF3F3F","bold":true,"clickEvent":{"action":"run_command","value":"/trigger uhc.game.end add 1"}},{"text":"\nCONFIRM\n","color":"#CF3F3F"}]
