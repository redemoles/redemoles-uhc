...
#> fte:summon/lancer/item_detection
#
...
execute store result score @s fte.item2 run clear @s minecraft:stick 0
...
execute unless score Lancer fte.data.roles matches 1 run function fte:summon/_no_team/cancel
execute if score Lancer fte.data.roles matches 1 if entity @s[scores={fte.item1=1..,fte.item2=64..},level=25..] run function fte:summon/lancer/success
