...
execute as @p[scores={fte.id.teams=8},tag=fte.item.saber] unless items entity @s inventory.* minecraft:diamond_sword[enchantments={levels:{'minecraft:sharpness':5}},item_name='{"text":"Saber","color":"dark_blue","bold":true,"underlined":true,"italic":false}',unbreakable={}] run give @s minecraft:diamond_sword[enchantments={levels:{'minecraft:sharpness':5}},item_name='{"text":"Saber","color":"dark_blue","bold":true,"underlined":true,"italic":false}',unbreakable={}]
