...
#> fte:artefact/servant/saber/start
#
# @within			fte:sceau/artefact_1
#
#
# @description		Activation de l'Artéfact de Saber
#
...
scoreboard players set #saber fte.artefact.timer 180
scoreboard players set #saber_tick fte.artefact.timer 0
