...
execute in minecraft:overworld run function dru:start/wb_start with storage uhc:settings
execute in minecraft:the_nether run function dru:start/wb_start with storage uhc:settings
execute in minecraft:the_end run function dru:start/wb_start with storage uhc:settings
