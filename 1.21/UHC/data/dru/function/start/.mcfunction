...
## Message start
tellraw @a[scores={uhc.players.lang=1}] [{"text":"\n[","color":"#DFC300","bold":true},{"text":"Dragon","color":"#5F2FBF"},{"text":" UHC","color":"#FFE73F"},{"text":"]","color":"#DFC300"},{"text":" La partie vient de démarrer !","color":"#FFE73F","bold":true}]
tellraw @a[scores={uhc.players.lang=2}] [{"text":"\n[","color":"#DFC300","bold":true},{"text":"Dragon","color":"#5F2FBF"},{"text":" UHC","color":"#FFE73F"},{"text":"]","color":"#DFC300"},{"text":" Game starting now!","color":"#FFE73F","bold":true}]
