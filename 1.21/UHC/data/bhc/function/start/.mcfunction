...
execute if score #bhc bhc.scenario matches 1 run scoreboard players operation #stepb_exhaustion bhc.data.temp = #stepb_exhaustion bhc.data.setup
...
execute if score #stepa_start bhc.data.setup matches -1 if score #bhc bhc.scenario matches 1 run scoreboard players add #stepb_exhaustion bhc.data.temp 1
...
execute if score #bhc bhc.scenario matches 1 run scoreboard players add #stepb_exhaustion bhc.data.temp 1
