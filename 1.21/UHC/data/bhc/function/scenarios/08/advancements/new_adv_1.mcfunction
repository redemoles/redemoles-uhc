...
## Scores
$execute if score #stepa_enabled bhc.data matches $(step) run function bhc:scenarios/08/bingo_stepa/team_reward/case with storage $(namespace) $(line)_$(column)
$execute if score #stepb_enabled bhc.data matches $(step) run function bhc:scenarios/08/bingo_stepb/team_reward/case with storage $(namespace) $(line)_$(column)
