...
# Message
tellraw @a [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" Début du Bingo ","color":"#BF7FFF","bold":false},{"text":"Spécial","color":"#9F3FFF","bold":true}]
