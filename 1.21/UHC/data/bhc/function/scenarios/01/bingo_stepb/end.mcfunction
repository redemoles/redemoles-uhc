...
# Msg FRA
execute as @a[scores={uhc.players.lang=1}] run tellraw @s [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" ","color":"#BF7FFF","bold":false},{"text":"Ruée vers l'or","color":"#FFE73F","bold":true},{"text":" terminée !","color":"#FFEF7F","bold":false}]
...
# Msg ENG
execute as @a[scores={uhc.players.lang=2}] run tellraw @s [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" ","color":"#BF7FFF","bold":false},{"text":"Gold Rush","color":"#FFE73F","bold":true},{"text":" is over!","color":"#FFEF7F","bold":false}]
