...
# Msg FRA
execute as @a[scores={uhc.players.lang=1}] run tellraw @s [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" Bingo ","color":"#BF7FFF","bold":false},{"text":"Ruée vers l'or","color":"#9F3FFF","bold":true},{"text":" terminé !","color":"#BF7FFF","bold":false}]
...
# Msg ENG
execute as @a[scores={uhc.players.lang=2}] run tellraw @s [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" ","color":"#BF7FFF","bold":false},{"text":"Gold Rush","color":"#9F3FFF","bold":true},{"text":" Bingo over!","color":"#BF7FFF","bold":false}]
