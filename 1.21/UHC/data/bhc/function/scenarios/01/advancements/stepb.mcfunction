...
$execute if score #team_first_$(line) bhc.data matches 1 run function bhc:scenarios/01/bingo_stepb/player_reward/line with storage $(namespace) $(line)_$(column)
$execute if score #team_first_$(column) bhc.data matches 1 run function bhc:scenarios/01/bingo_stepb/player_reward/column with storage $(namespace) $(line)_$(column)
