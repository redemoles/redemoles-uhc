...
$execute if score #stepb_enabled bhc.data matches $(step) run scoreboard players add #$(namespace)_$(line)_$(column) bhc.case 1
# Ligne
...
$execute if score #stepb_enabled bhc.data matches $(step) if score #$(namespace)_$(line)_$(column) bhc.case matches 3 run tellraw @a [{"text":"La case ","color":"#FF5F5F","bold":false},{"text":"[","color":"#7F1F1F","bold":false,"hoverEvent":{"action":"show_text","contents":{"text":"$(description)","color":"#FFBFBF"}}},{"text":"$(title)","color":"#FF3F3F","bold":false,"hoverEvent":{"action":"show_text","contents":{"text":"$(description)","color":"#FFBFBF"}}},{"text":"]","color":"#7F1F1F","bold":false,"hoverEvent":{"action":"show_text","contents":{"text":"$(description)","color":"#FFF7BF"}}},{"text":" a été vérouillée !","bold":false}]
...
$execute if score #stepb_enabled bhc.data matches $(step) if score #$(namespace)_$(line)_$(column) bhc.case matches 3 run advancement grant @a[tag=uhc.player] only $(namespace):$(line)_$(column)
