...
#> bhc:scenarios/02/bingo_stepa/selector
#
...
execute if score #select_roll bhc.data matches 1 if score #select_B01 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 2 if score #select_B02 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 3 if score #select_B03 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 4 if score #select_B04 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 5 if score #select_B05 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 6 if score #select_B06 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 7 if score #select_B07 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 8 if score #select_B08 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 9 if score #select_B09 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 10 if score #select_B10 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 11 if score #select_B11 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
execute if score #select_roll bhc.data matches 12 if score #select_B12 bhc.data matches 10 run function bhc:scenarios/02/bingo_stepa/selector
