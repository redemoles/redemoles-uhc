...
execute if score #start_stepb bhc.timer >= #bingo_b_end bhc.timer unless score #end uhc.game.end matches 1.. run scoreboard objectives setdisplay sidebar bhc.total.rank.score
