...
execute if score #Secondes uhc.data.display matches 15 run scoreboard objectives setdisplay sidebar bhc.total.score
execute if score #Secondes uhc.data.display matches 30 run scoreboard objectives setdisplay sidebar bhc.bingo.score
execute if score #Secondes uhc.data.display matches 45 run scoreboard objectives setdisplay sidebar bhc.total.score
