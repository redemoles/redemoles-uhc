...
execute as @p[tag=host.world_generation.nether] run scoreboard players set #chunk_pregen worldpregen 5257
...
execute if score #chunk_pregen worldpregen matches 5257 run tag @a[scores={worldpregen=1..}] add host.world_generation.nether
execute if score #chunk_pregen worldpregen matches 5257 run scoreboard players set #chunk_pregen worldpregen 6000
