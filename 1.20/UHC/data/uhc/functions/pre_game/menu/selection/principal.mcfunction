...
execute if score #principal uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:14b,tag:{display:{Name:'{"text":"Mode de jeu","color":"#FF3F3F","italic":false}'}}}] run function uhc:pre_game/menu/load/gamemode/
execute if score #principal uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:15b,tag:{display:{Name:'{"text":"Scenarios","color":"#CF3FFF","italic":false}'}}}] run function uhc:pre_game/menu/load/scenarios/1
execute if score #principal uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:16b,tag:{display:{Name:'{"text":"Paramètres","color":"#CFCFCF","italic":false}'}}}] run function uhc:pre_game/menu/load/settings/
