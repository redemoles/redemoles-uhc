...
execute if score #bhc uhc.gamemode matches 0 run title @a[tag=uhc.spec] actionbar [{"text":"Choisis ton équipe dans l'inventaire","color":"#3F9FFF","bold":true}]
execute if score #bhc uhc.gamemode matches 1 run title @a[tag=uhc.spec] actionbar [{"text":"Choisis ton équipe dans l'inventaire","color":"#9F3FFF","bold":true}]
