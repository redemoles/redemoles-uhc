...
# Fin d'Artéfact
execute if score #r_assassin_tick fte.artefact.timer matches 1.. if entity @p[tag=fte.roles.servant,scores={fte.id.teams=2}] run function fte:summon/assassin/end
