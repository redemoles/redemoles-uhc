...
give @a[tag=uhc.player] minecraft:iron_pickaxe{Enchantments:[{id:"minecraft:efficiency",lvl:2s}],Unbreakable:1b}
give @a[tag=uhc.player] minecraft:iron_axe{Enchantments:[{id:"minecraft:efficiency",lvl:2s}],Unbreakable:1b}
give @a[tag=uhc.player] minecraft:iron_shovel{Enchantments:[{id:"minecraft:efficiency",lvl:2s}],Unbreakable:1b}
