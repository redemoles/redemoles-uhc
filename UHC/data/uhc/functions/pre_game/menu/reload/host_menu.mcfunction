...
item replace entity @s inventory.5 with minecraft:command_block{display:{Name:'{"text":"Mode de jeu","color":"#FF3F3F","italic":false}'}}
item replace entity @s inventory.6 with minecraft:repeating_command_block{display:{Name:'{"text":"Scenarios","color":"#CF3FFF","italic":false}'}}
item replace entity @s inventory.7 with minecraft:chain_command_block{display:{Name:'{"text":"Paramètres","color":"#CFCFCF","italic":false}'}}
