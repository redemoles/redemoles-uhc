...
execute if score #fte uhc.gamemode matches 0 if score #gamemode uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:11b,tag:{display:{Name:'{"text":"Fate UHC","color":"#FF3F3F","italic":false}'}}}] run function uhc:pre_game/menu/load/gamemode/fte/
execute if score #fte uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:11b,tag:{display:{Name:'{"text":"Fate UHC","color":"#3FFFFF","italic":false}'}}}] run function uhc:pre_game/menu/load/gamemode/fte/
execute if score #nzl uhc.gamemode matches 0 if score #gamemode uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:12b,tag:{display:{Name:'{"text":"Nuzlocke UHC","color":"#FF3F3F","italic":false}'}}}] run function uhc:pre_game/menu/load/gamemode/nzl/
execute if score #nzl uhc.gamemode matches 1 if score #gamemode uhc.host.menu matches 1 unless data entity @s Inventory[{Slot:12b,tag:{display:{Name:'{"text":"Nuzlocke UHC","color":"#3FFFFF","italic":false}'}}}] run function uhc:pre_game/menu/load/gamemode/nzl/
