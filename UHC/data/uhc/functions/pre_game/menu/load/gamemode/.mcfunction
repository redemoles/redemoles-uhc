...
execute if score #fte uhc.gamemode matches 0 run item replace entity @s inventory.2 with minecraft:red_concrete{display:{Name:'{"text":"Fate UHC","color":"#FF3F3F","italic":false}'}}
execute if score #fte uhc.gamemode matches 1 run item replace entity @s inventory.2 with minecraft:light_blue_concrete{display:{Name:'{"text":"Fate UHC","color":"#3FFFFF","italic":false}'}}
execute if score #nzl uhc.gamemode matches 0 run item replace entity @s inventory.3 with minecraft:red_concrete{display:{Name:'{"text":"Nuzlocke UHC","color":"#FF3F3F","italic":false}'}}
execute if score #nzl uhc.gamemode matches 1 run item replace entity @s inventory.3 with minecraft:light_blue_concrete{display:{Name:'{"text":"Nuzlocke UHC","color":"#3FFFFF","italic":false}'}}
