...
tellraw @a[scores={uhc.players.lives=3},predicate=uhc:id_teams] [{"text":"[","color":"#DFC300","bold":true},{"text":"Bingo","color":"#BF7FFF"},{"text":"UHC","color":"#9F3FFF"},{"text":"]","color":"#DFC300"},{"text":" Le nombre de vies maximum descend à 2 !","color":"#FF3F3F","bold":false}]
give @a[scores={uhc.players.lives=3},predicate=uhc:id_teams] golden_apple 2

execute store result score #count bhc.data if entity @a[scores={uhc.players.lives=3},predicate=uhc:id_teams]
